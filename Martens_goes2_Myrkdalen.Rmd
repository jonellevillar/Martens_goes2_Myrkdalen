...
## Factors that influence the efficieny of AP
   - Age, gender, smoking 
   - Genotype - i.e. metabolic enzymes
   - Polypharmacy
...
## What does the literature show?
   ...
   - GWAS - multiple neurotransmitter systems/genes
...
Challenges to teasing out medication effects on DNAm.
   - Polypharmacy
   - Small sample size for monotherapy
   - Missing values 
   - Study design
...
## Considerations:
   ...
   - Evaluate serum values (van Dongen)
...
## Results for CpGs at Genome-wide significance
   ...
   - GLT8D1: Glycosyltransferase 8 Domain Containing 1 <br/>
   - SPCS1: signal peptidase complex subunit 1 <br/>
   - LOC100507065:long noncoding RNA <br/>
