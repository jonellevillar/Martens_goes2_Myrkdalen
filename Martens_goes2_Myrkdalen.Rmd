...
---
## Example of model chosen for Quetiapine

DNAm ~ Serum1 + Serum2 + Serum_Lithium + Age + Sex + Smoking (+ eCells)
...
![]url(slides/Que_n92_Mod1_manhatt.png)
...
![]url(slides/Que_n92_Mod2_manhatt.png)
